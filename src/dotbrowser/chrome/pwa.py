"""Chrome PWA -- browser-specific config + thin wrappers."""
...
_PWA_CONFIG = _base.PwaConfig(
    browser_name="chrome",
    linux_policy_path="/etc/opt/chrome/policies/managed/dotbrowser-pwa.json",
    macos_plist_path="/Library/Managed Preferences/com.google.Chrome.plist",
    windows_registry_key=r"Software\Policies\Google\Chrome",
)
...
def cmd_dump(args: argparse.Namespace) -> None:
    _base.cmd_dump(
        "chrome", POLICY_FILE, _WINDOWS_POLICY_KEY,
